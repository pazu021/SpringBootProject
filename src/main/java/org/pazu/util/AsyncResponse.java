 ...
 *
 * @param <V>
 *            The type of Value object wrapped and returned by the
 *            AsyncResponse.
 */
public class AsyncResponse<V> implements Future<V> {
	 ...
	 * 
	 * @param val
	 *            An object of type V used as the task response value.
	 */
	 ...
	 * 
	 * @param timeout
	 *            A long number of milliseconds after which the process ceases
	 *            to wait for state change.
	 * @throws InterruptedException
	 *             Thrown when the blocking operation is interrupted.
	 */
